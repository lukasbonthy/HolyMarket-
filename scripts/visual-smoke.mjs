...
await ipad.page.locator('[data-action="ticket-outcome"][data-index="1"]').click();
await ipad.page.locator('[data-action="quick-add"][data-value="5"]').click();
await ipad.page.locator('[data-action="lock-prediction"]').click();
